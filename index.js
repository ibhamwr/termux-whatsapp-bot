...
const ow = 'Ibham';
const nomorowner = '082117696469';
const pulsa = '082117696469';
const instagram = 'https://www.instagram.com/ft_ibham/';
const aktif = '06:00 - 01:00';
const vcard = 'BEGIN:VCARD\n'
  + 'VERSION:3.0\n'
  + 'FN:Ibham\n' // Nama kamu
  + 'ORG:18H4M\n' // Nama bot
  + 'TEL;type=CELL;type=VOICE;waid=6282117696469:+62 821-1769-6469\n' //Nomor whatsapp kamu
  + 'END:VCARD'
//
const
  {
...
*Pulsa :* _${pulsa}_`, MessageType.text, { quoted: m });
  }
...
╠════════════════════
╠≽ *.Kata (quotes/author)*
╠ _Ex = .Kata Aku cinta dia/Ibham_ 
╠≽ *.Logopornhub (teks1/teks2)*
╠ _Ex : .Logopornhub Ibham/nime_
╠≽ *.Lion (teks1/teks2)*
╠ _Ex : .Lion Ibham/nime_
╠≽ *.Ninja (teks1/teks2)*
╠ _Ex : .Ninja Ibham/nime_
╠≽ *.Joker (teks1/teks2)*
╠ _Ex : .Joker Ibham/nime_
╠≽ *.Glitch (teks1/teks2)*
╠ _Ex : .Glich Ibham/nime_
╠≽ *.Wolf (teks1/teks2)*
╠ _Ex : .Wolf Ibham/nime_
╠≽ *.Snow (teks)*
╠ _Ex : .Snow Ibham_
╠≽ *.Neon1 (teks)*
╠ _Ex : .Neon1 Ibham_
...
╠════════════════════
╠≽ *.Bit8 (text/text)*
╠ _Ex = .Bit8 Ibham/nime_ 
╠≽ *.Pubg (teks1/teks2)*
╠ _Ex : .Pubg Ibham/nime_
╠≽ *.Batllef (teks1/teks2)*
╠ _Ex : .Battlef Ibham/nime_
╠≽ *.Shadow (teks)*
╠ _Ex : .Shadow Ibham_
╠≽ *.Paper1 (teks)*
╠ _Ex : .Paper Ibham_
...
╠ _Ex = .Arti Ibham_ 
╠≽️ *.Couple (Namamu & doi)*
╠ _Ex = .Couple Ibham & Najma_ 
╠≽️ *.Getzodiak (Nama & tgl)
╠ _Ex : .Getzodiak Ibham & 23-06-2006_ 
